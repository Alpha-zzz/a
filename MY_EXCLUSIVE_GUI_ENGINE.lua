...
local Players            = game:GetService("Players")--[[
    af_hub GUI ENGINE - ULTIMATE V2
    Rayfield Compatible

    V2:
    - Boot animation (2 sec)
    - K key toggle open/close
    - Minimize button
    - Draggable window
...
function MyEngine:Notify(Data)
    ...
    pcall(function() NotifyGui.IgnoreGuiInset = true end)
...
print("[af_hub] GUI ENGINE V2 - LOADED")
print("[af_hub] K = toggle open/close | drag title to move")
